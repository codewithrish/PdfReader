...
object CwrIcons {
    ...
    // Bookmark
    val BookmarkAdd = Icons.Outlined.FavoriteBorder
    val BookmarkAdded = Icons.Filled.Favorite
    val Icon3Dots = Icons.Default.MoreVert

    // Settings
    val ChevronRight = Icons.Default.ChevronRight
    val LightTheme = Icons.Outlined.DarkMode
    val DarkTheme = Icons.Filled.DarkMode
    val Language = Icons.Outlined.Language
    val StarRate = Icons.Outlined.StarRate
    val PrivacyPolicy = Icons.Outlined.Policy
    val AppVersion = Icons.Outlined.Gesture
